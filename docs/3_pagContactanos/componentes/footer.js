...
function mostrarFooter(){
    footer.innerHTML = `
        ...
        <article class="socialMedia">
            <h3>¡HABLEMOS!</h3>
            <div class="redes">
            <a href="#"><img src="/3_pagContactanos/icons/whatsapp-white.svg" alt="whatsapp-icon" /></a>
            <a href="#"><img src="/3_pagContactanos/icons/instagram-white.svg" alt="instagram-icon" /></a>
            <a href="#"><img src="/3_pagContactanos/icons/email-white.svg" alt="email-icon" /></a>
            </div>
        </article>
        <article class="logo">
